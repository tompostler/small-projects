...
class PerformanceTesting
{
    ...
    /// </summary>
    private static void DoTheThing0()
    {
        throw new NotImplementedException();
    }

    /// <summary>
    /// Optionally define this one to do a comparison perf test
    /// </summary>
    private static void DoTheThing1()
    {
        throw new NotImplementedException();
    }
    ...
    private static void TimeOperations()
    {
        ...
        for (int whichDoTheThing = 0; whichDoTheThing < 2; whichDoTheThing++)
        {
            if (whichDoTheThing == 1)
            {
                try
                {
                    DoTheThing1();
            ...
            Console.WriteLine("Statistics for DoTheThing{0}:", whichDoTheThing);
            Console.WriteLine("  Slowest time:  Iteration {0,4} = {1,4} ticks -> {2,6} nanoseconds", indexSlowest, maxTicks, maxTicks * nanosecPerTick);
            Console.WriteLine("  Fastest time:  Iteration {0,4} = {1,4} ticks -> {2,6} nanoseconds", indexFastest, minTicks, minTicks * nanosecPerTick);
